...
<tr>
<th>ServerName:</th>
<td><select id="ServerNameN" class="rownasie" onchange="javascript:tabelka('done')">
...
<td>
<input class="tekst" type="text" id="ServerName" value="<?=htmlentities(strip_tags($_GET['ServerName']));?>" onchange="javascript:tabelka('done')">
</td>
<th>QDB:</th>
<td>
<select id="QDBN" class="rownasie" onchange="javascript:tabelka('done')">
<option value="" <?if($_GET['QDBN']=="" || empty($_GET['QDBN'])) echo "SELECTED";?>>=</option>
<option value="NOT" <?if($_GET['QDBN']=="NOT") echo "SELECTED";?>>&ne;</option>
</select></td>
<td>
<input id="QDB" class="tekst" type="text" value="<?=strip_tags($_GET['QDB']);?>" onchange="javascript:tabelka('done')">
</td>
</tr>
<tr>
<th>Agent:</th>
<td>
<select id="AgentN" class="rownasie" onchange="javascript:tabelka('done')">
...
<td>
<select id="Agent" class="wartosc" onchange="javascript:tabelka('done')">
<option value="" <?if(empty($_GET['Agent']) || $_GET['Agent']=='') echo 'SELECTED'?>>All</option>
				<?$query="EXEC dbo.Deployment_tabelkadone
@element='Agent',
...
<th>Status:</th>
<td>
<select id="StatusN" class="rownasie" onchange="javascript:tabelka('done')">
...
<td>
<select id="Status" class="wartosc" onchange="javascript:tabelka('done')">
...
<th>Windows:</th>
<td>
<select id="WinOSN" class="rownasie" onchange="javascript:tabelka('done')">
...
<td>
<select id="WinOS" class="wartosc" onchange="javascript:tabelka('done')">
<option value="" <?if(empty($_GET['WinOS']) || $_GET['WinOS']=='') echo 'SELECTED'?>>All</option>
				<?$query="
				EXEC dbo.Deployment_tabelkadone
@element='WinOS',
@servername='".htmlentities(strip_tags($_GET['ServerName']))."',
@alerting='".$_GET['AGroup']."%',
@agent='".$_GET['Agent']."%',
...
<th>Group:</th>
<td>
<select id="AGroupN" class="rownasie" onchange="javascript:tabelka('done')">
...
<td>
<select id="AGroup" class="wartosc" onchange="javascript:tabelka('done')">
...
<th>Week:</th>
<td>
<select id="WeekN" class="rownasie" onchange="javascript:tabelka('done')">
...
<td>
<select id="Week" class="wartosc" onchange="javascript:tabelka('done')">
...
<th>CIM/DELL:</th>
<td>
<select id="CIMN" class="rownasie" onchange="javascript:tabelka('done')">
<option value="" <?if($_GET['CIMN']=="" || empty($_GET['CIMN'])) echo "SELECTED";?>>=</option>
<option value="NOT" <?if($_GET['CIMN']=="NOT") echo "SELECTED";?>>&ne;</option>
</select></td>
<td>
<select id="CIM" class="wartosc" onchange="javascript:tabelka('done')">
...
<th>System:</th>
<td>
<select id="SystemN" class="rownasie" onchange="javascript:tabelka('done')">
...
<td>
<select id="System" class="wartosc" onchange="javascript:tabelka('done')">
...
<th>AD:</th>
<td>
<select id="ADN" class="rownasie" onchange="javascript:tabelka('done')">
<option value="" <?if($_GET['ADN']=="" || empty($_GET['ADN'])) echo "SELECTED";?>>=</option>
<option value="NOT" <?if($_GET['ADN']=="NOT") echo "SELECTED";?>>&ne;</option>
</select></td>
<td>
<select id="AD" class="wartosc" onchange="javascript:tabelka('done')">
...
<th>RuleName:</th>
<td>
<select id="RuleNameN" class="rownasie" onchange="javascript:tabelka('done')">
...
<td>
<input id="RuleName" class="tekst" type="text" value="<?=strip_tags($_GET['RuleName']);?>" onchange="javascript:tabelka('done')">
</td>
</tr>
<tr>
<th>Resp.:</th>
<td>
<select id="RespN" class="rownasie" onchange="javascript:tabelka('done')">
...
<td>
<select id="Resp" class="wartosc" onchange="javascript:tabelka('done')">
...
<th>Comments:</th>
<td>
<select id="CommentsN" class="rownasie" onchange="javascript:tabelka('done')">
...
<td>
<input id="Comments" class="tekst" type="text" value="<?=htmlentities(strip_tags($_GET['Comments']));?>" onchange="javascript:tabelka('done')">
</td>
</tr>
<tr>
<th>Disp.:</th>
<td>
<select id="DispN" class="rownasie" onchange="javascript:tabelka('done')">
...
<td>
<select id="Disp" class="wartosc" onchange="javascript:tabelka('done')">
...
<?
$query="EXEC dbo.DeploymentIloscDone
@servername='".htmlentities(strip_tags($_GET['ServerName']))."',
@alerting='".$_GET['AGroup']."%',
@agent='".$_GET['Agent']."%',
@notagent='".$_GET['AgentN']."',
...
<input type="submit" value="Go!" class="ui-state-default ui-corner-all" onclick="javascript:wykonaj('done')">
</center>
<?
/*echo "<pre>";
print_r($_GET);
