...
$zapytanie="EXEC dbo.DeploymentDone
...
<?}else{?>
<center>
<input type="text" value="Deployment - Done" disabled="true" id="identyfikator">
...
<td style="text-align:center;"><textarea id="RN000001" style="border:0; overflow:auto;height:80px;width:190px;" onfocus="javascript:zaznacz('000001','RN')" onblur="javascript:odznacz('000001','RN')"></textarea></td>
<td style="text-align:center;"><textarea id="Cm000001" style="border:0; overflow:auto;height:80px;width:190px;" onfocus="javascript:zaznacz('000001','Cm')" onblur="javascript:odznacz('000001','Cm')"></textarea></td>
<td></td>
...
<?}
?>
<td><textarea class="niezaznaczony" id="RuleName<?=$row['ServerName'];?>" style="border:0;overflow:auto;height:80px;width:190px;opacity:0.85;" onfocus="javascript:zaznacz('<?=$row['ServerName'];?>','RuleName')" onblur="javascript:odznacz('<?=$row['ServerName'];?>','RuleName')"><?=$row['RuleName'];?></textarea></td>
<td><textarea class="niezaznaczony" id="Comments<?=$row['ServerName'];?>" style="border:0;overflow:auto;height:80px;width:190px;opacity:0.85;" onfocus="javascript:zaznacz('<?=$row['ServerName'];?>','Comments')" onblur="javascript:odznacz('<?=$row['ServerName'];?>','Comments')"><?=$row['Comments'];?></textarea></td>
